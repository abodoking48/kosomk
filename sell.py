...
sell_router = Blueprint('sell_router',__name__, static_folder='static', template_folder='templates')
...
def sell():
    ...
    if not address :
        return flash("invaild address")
    if not price :
        return flash("invaild price")
    if not rooms :
        return flash("invaild rooms")
    if not space :
        return flash("invaild space")
    if not descrp :
        return flash("invaild descrpition")
    if not phone :
        return flash("invaild phone_number")
